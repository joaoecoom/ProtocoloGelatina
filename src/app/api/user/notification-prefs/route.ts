...
import { notificationPrefsBodySchema } from "@/lib/validators";
...
export async function POST(request: Request) {
  ...
  const parsed = notificationPrefsBodySchema.safeParse(json);
  if (!parsed.success) {
  ...
  try {
    ...
    console.error("[api/user/notification-prefs]", e);
